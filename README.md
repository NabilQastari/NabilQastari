...
I'm a developer who works across the full stack — from building responsive web interfaces and REST APIs to shipping mobile apps and tinkering with game dev on the side. I also care about design, so my tools go beyond just code.

- 🔭 Currently building web & mobile products with Laravel, React, and Flutter
- 🎮 Hobby: game dev with Unity & Godot, 3D with Blender
- 🎨 I do my own UI design — Figma, Illustrator, and friends
- 🌍 Based in Indonesia
